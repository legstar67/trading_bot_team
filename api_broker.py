...
class ApiBroker:
    ...
    def get_open_orders_futures(self, symbol: str = None):
        """Get open orders for a specific futures trading pair.
        Args:
            symbol (str, optional): The trading pair symbol, e.g., "BTCUSDT". If not provided, will return open orders for all pairs.
        Returns:
            dict: A dictionary containing open orders information.
        Docs :
            https://developers.binance.com/docs/derivatives/usds-margined-futures/trade/rest-api/Current-All-Open-Orders
        """
        endpoint = self.endpoints[Endpt_name.Get_open_orders_futures]
        url = self.endpoints[Endpt_name.URL]
    ...
    def get_account_info_futures(self):
        """Get account information for futures trading (like balance, unrealized PNL, positions and assets).
        Returns:
...
class Endpt_name(Enum):
    ...
    Get_open_orders_futures = "get_open_orders_futures" 
    Get_positions_futures = "get_positions_futures"  
